package com.com.example.encoder;
/*
 * UVCCamera
...
//    		android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
    		try {
	            final int min_sz = AudioRecord.getMinBufferSize(SAMPLE_RATE, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT);
	            ...
	            try {
	            	if (mIsCapturing) {
	    				if (DEBUG) Log.v(TAG, "AudioThread:start audio recording"+audioRecord.getState());
